            ...
            >
                {children || (
                    <span className="truncate">
                        {event.name} | {event.platform.charAt(0).toUpperCase() + event.platform.slice(1)}
                    </span>
                )}
            </EventWrapper>
        );
            ...
            >
                {durationMinutes < 45 ? (
                    ...
                    <>
                        ...
                        {showTime && <div className="truncate text-[11px] font-normal opacity-70">{getEventTime()}</div>}
                    </>
                )}
            </EventWrapper>
        );
